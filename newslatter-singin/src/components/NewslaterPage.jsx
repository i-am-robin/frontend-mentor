...
function NewslaterPage() {
  ...
  return (
    <div className="m-auto flex h-full w-full flex-col justify-between gap-4 bg-white lg:h-fit lg:w-fit lg:flex-row-reverse lg:rounded-2xl lg:p-4 lg:shadow-xl">
